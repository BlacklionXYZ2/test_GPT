...
from gpt_1 import text_to_token, token_to_text
# \
    ...
    for epoch in range(num_epochs):
        ...
        for input_batch, target_batch in train_loader:
            ...
            if global_step % eval_freq == 0:
                train_loss, valid_loss = evaluate_model(model, train_loader, valid_loader, device, eval_iter) # find a function for this
